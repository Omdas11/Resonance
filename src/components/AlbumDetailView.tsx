        ...
        <div className="flex flex-col justify-end gap-2">
          ...
          <div className="flex gap-3 mt-2">
            <button
              ...
              className="flex items-center gap-2 px-6 py-2 bg-[#fc3c44] hover:bg-[#e0333b] text-white rounded-full text-sm font-semibold transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2 bg-white/10 hover:bg-white/20 text-white rounded-full text-sm font-semibold transition-colors"
            >
